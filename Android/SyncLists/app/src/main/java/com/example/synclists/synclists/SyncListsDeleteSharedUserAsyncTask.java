 ...
 */
public class SyncListsDeleteSharedUserAsyncTask extends SyncListsRequestAsyncTask  {
    public SyncListsDeleteSharedUserAsyncTask(SyncListsRequestAsyncTaskCallback callback) {
        super(callback);
    }
