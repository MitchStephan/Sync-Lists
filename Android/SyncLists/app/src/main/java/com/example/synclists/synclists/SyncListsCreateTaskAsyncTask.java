 ...
 */
public class SyncListsCreateTaskAsyncTask extends SyncListsRequestAsyncTask  {
    public SyncListsCreateTaskAsyncTask(SyncListsRequestAsyncTaskCallback callback) {
        super(callback);
    }
