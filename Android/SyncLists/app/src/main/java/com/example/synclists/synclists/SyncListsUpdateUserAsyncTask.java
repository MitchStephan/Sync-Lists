 ...
 */
public class SyncListsUpdateUserAsyncTask extends SyncListsRequestAsyncTask {
    public SyncListsUpdateUserAsyncTask(SyncListsRequestAsyncTaskCallback callback) {
        super(callback);
    }
